...
class WorkflowEditModalView extends React.Component {
    renderWfTab () {
        const {wfDataItems, onClickAddShape, onCloseShapeMenu, shapeAnchorEl,
            shapes, onClickShape, onClickDeleteShape, onClickEditShape} = this.props
        return (
    ...
    renderTabContent () {
        ...
        switch (tab) {
            case "wf": return this.renderWfTab()
            case "filter": return this.renderFilterTab()
            case "general": return this.renderGeneralTab()
            case "security": return this.renderSecurityTab()
            case "actions": return this.renderTabActions()
            case "schedule": return this.renderTabSchedule()
            default: return null
        }
    }
