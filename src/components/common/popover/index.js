...
class Popover extends React.Component {
  ...
  trackPopover() {
    ...
    /* This should take place before we measurePopoverSize so there is no lag
    at first boot */
    if (this.props.targetAsMinWidth) {
      this.containerEl.style.minWidth = `${this.targetBounds.w}px`
    }
