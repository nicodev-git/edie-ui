...
import ParsersModal from './ParsersModal.jsx'
import MTypeModal from './MTypeModal.jsx'
...
export default class SimulatorModal extends React.Component {
                    ...
                    <div className="panel panel-default panel-noborder">
                        <div className="panel-heading" style={{display: this.props.options.hideAddButton ? "none" : "block"}}>
                            <a href="javascript:;" onClick={this.onClickAddRule.bind(this)}>
                                <i className="fa fa-x fa-plus-square" title="Add Rule"></i></a>
                        </div>
                        <div className="panel-body">
                            ...
                            <div className="row margin-md-bottom">
                                ...
                                <div className="col-md-10">
                                    <input type="text" className="form-control" ref="filter1"
                            ...
                            <div className="row margin-md-bottom">
                                ...
                                <div className="col-md-10">
                                    <input type="text" className="form-control" ref="filter2"
                            ...
                            <div className="row margin-md-bottom">
                                ...
                                <div className="col-md-8">
                                    <input className="form-control" ref="parser"
                                           value={this.state.parser} onChange={this.onChangeParser.bind(this)}/>
                                </div>
                                ...
                                <div className="col-md-8">
                                    <div className="padding-sm" style={{backgroundColor: "#f5f5f5"}}>
                                        ...
                                        <a href="javascript:;" onClick={this.onClickAddM.bind(this)}
                                           className="margin-sm-left"><i className="fa fa-x fa-plus-square"></i></a>

                                        <a href="javascript:;" onClick={this.onClickEditM.bind(this)}
                                           className="margin-sm-left"><i className="fa fa-x fa-edit"></i></a>

                                        <a href="javascript:;" onClick={this.onClickRemoveM.bind(this)}
                                           className="margin-sm-left"><i className="fa fa-x fa-trash-o"></i></a>

                                        <a href="javascript:;" onClick={this.onClickMoveUpM.bind(this)}
                                           className="margin-sm-left"><i className="fa fa-x fa-caret-square-o-up"></i></a>

                                        <a href="javascript:;" onClick={this.onClickMoveDownM.bind(this)}
                                           className="margin-sm-left"><i className="fa fa-x fa-caret-square-o-down"></i></a>

                                        <a href="javascript:;" onClick={this.onClickRefreshM.bind(this)}
                                           className="margin-sm-left"><i className="fa fa-x fa-refresh"></i></a>
                                    </div>
                                </div>
                            </div>
                            <div className="row margin-md-bottom">
    ...
    onClickEditM() {
        ...
        var data = this.state.mdata[this.state.selectedIndex];
    ...
    onClickRun() {
        ...
        $.get(Api.rule.runSimulator, params)
            .done( res => {
            $.each(res.object, (key, value) => {
