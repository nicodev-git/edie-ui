...
class LogMatchModal extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            open: true
                    ...
                    <div className="panel panel-default">
                        <div className="panel-heading">
                            ...
                            <div className="panel-options">
                                <a href="javascript:;" className="option trash"> <i
                                    className="fa fa-trash-o"></i>
                                </a>
                                <a href="javascript:showMatchEdit(false);"
                                   className="option add-device"> <i className="fa fa-plus-square"></i>
                                </a>
                            </div>
                        </div>
