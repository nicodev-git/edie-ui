                ...
                <div className="text-center margin-md-top">
                    ...
                    <div style={{position:"absolute", right:"25px"}}>
                        <ButtonGroup>
                            ...
                            {
                                userPage ?
                                    <DropdownButton title="Edit" id="dd-setting-group-edit" pullRight={true}>
                                    ...
                                    <DropdownButton title="Edit" id="dd-setting-user-edit" pullRight={true}>
                            ...
                            <DropdownButton title={<i className="fa fa-gear"/>}
                                            id="dd-setting-user-more" pullRight={true}>
