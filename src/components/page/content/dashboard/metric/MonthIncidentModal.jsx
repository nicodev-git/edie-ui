...
import { dateFormatter, getSeverityIcon, getIncidenttypeIcon } from 'shared/Global.jsx'
...
class MonthIncidentModal extends React.Component {
    constructor(props) {
        super(props)
        this.state = {
            open: true,
    ...
    onClickFixAll() {
        showPrompt("Please type comment for all incidents.", "", (text) => {
            ...
            $.get(Api.incidents.fixMonthIncidents, {
                comment: text,
            }).done(res => {
                this.reloadTable()
            })
...
MonthIncidentModal.defaultProps = {}

export default MonthIncidentModal