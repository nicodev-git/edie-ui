...
import { chatSocket } from 'util/socket/ChatSocket.jsx'
import { showAlert } from 'components/shared/Alert.jsx'

import { scrollBottom } from 'util/Scroll.jsx'
...
class Chat extends React.Component {
                        ...
                        <div className="channel-textarea">
                            <div className="channel-textarea-inner">
                                ...
                                <textarea rows="1" placeholder="Chat in general..."
                                          ...
                                          onBlur={this.onTextBlur.bind(this)}></textarea>
                            </div>
                        </div>
        ...
        return (
            <div className="message-group" key={item.id}>
                <div className="avatar-large"
                     style={{backgroundImage: 'url(/externalpictures?name=' + pictureId  + ')'}}></div>
            ...
            <div className="member" key={user.userName}>
                <div className={"avatar-small " + (typing ? 'animate': '')}
                    ...
                    <div className={"status " +  (user.online ? "online" : "idle") + ' ' + (typing ? 'status-typing' : '')}>
                        <div className={"ellipsis" + (typing ? '' : 'hidden')}><div></div><div></div><div></div></div>
                    </div>
                </div>
    ...
    showDefaultIncident() {
        ...
        if (this.state.incidents.length)
            this.onClickIncident(this.state.incidents[0])
    }
