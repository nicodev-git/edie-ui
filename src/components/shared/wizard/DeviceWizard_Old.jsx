...
import Combo from './input/Combo.jsx'
import Password from './input/Password.jsx'
import RadioCombo from './input/RadioCombo.jsx'
import AdvancedForm from './input/AdvancedForm.jsx'
import Checkbox from './input/Checkbox.jsx'
import PortList from './input/PortList.jsx'
import MatchIgnore from './input/MatchIgnore.jsx'
import GlobalIgnore from './input/GlobalIgnore.jsx'
import MTable from './input/MTable.jsx'
import MonitorTable from './input/MonitorTable.jsx'
...
export default class DeviceWizard extends React.Component {
    ...
    prepareRequest() {
        ...
        let addParam = (key, value) => {
            ...
            var mapped = jsonMapping.indexOf(key) >= 0;
