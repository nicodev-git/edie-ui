            ...
            <div className="panel panel-default panel-noborder">
                <div className="panel-heading" style={{height:"35px"}}>
                    ...
                    <div className="panel-options">
                        <a href="javascript:;"
                           onClick={this.onClickAdd.bind(this)}><i className="fa fa-x fa-plus-square"></i></a>
                        <a href="javascript:;" className="margin-xs-left"
                           onClick={this.onClickEdit.bind(this)}><i className="fa fa-x fa-edit"></i></a>
                        <a href="javascript:;" className="margin-xs-left"
                           onClick={this.onClickRemove.bind(this)}><i className="fa fa-x fa-trash-o"></i></a>
                        <a href="javascript:;" className="margin-xs-left"
                           onClick={this.onClickUp.bind(this)}><i className="fa fa-x fa-caret-square-o-up"></i></a>
                        <a href="javascript:;" className="margin-xs-left"
                           onClick={this.onClickDown.bind(this)}><i className="fa fa-x fa-caret-square-o-down"></i></a>
                    </div>
                </div>
