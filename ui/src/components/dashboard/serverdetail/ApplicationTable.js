...
import {TextField, FlatButton, RaisedButton, MenuItem, ToolbarGroup} from 'material-ui'
...
export default class ApplicationTable extends Component {
  ...
  renderOptions () {
    ...
    return [
      <ToolbarGroup firstChild={true} key="0">
  ...
  render () {
    ...
    return (
      <TabPage>
        <TabPageHeader title="Applications" titleOptions={<StatusImg {...this.props}/>} useToolBar>
          {this.renderOptions()}
        </TabPageHeader>
